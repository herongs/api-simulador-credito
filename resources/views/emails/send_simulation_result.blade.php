...
<body>
    <div style="font-family: Roboto, sans-serif; max-width: 600px; margin: 0 auto">
        ...
        <div style="padding: 20px;">
            ...
            <p>
                Valor inicial do empréstimo: <b>R$ {{ number_format($simulation->loan_amount, 2, ',', '.') }}</b><br>
            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="padding: 8px; border-bottom: 1px solid #ddd;">R$ {{ number_format($simulation->total_payment, 2, ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; border-bottom: 1px solid #ddd;">Valor da parcela mensal</td>
                        <td style="padding: 8px; border-bottom: 1px solid #ddd;">R$ {{ number_format($simulation->monthly_payment, 2, ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 8px;">Total de juros</td>
                        <td style="padding: 8px;">R$ {{ number_format($simulation->total_interest, 2, ',', '.') }}</td>
                    </tr>
                </tbody>
            </table>
